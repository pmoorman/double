          ...
          <div className={cn(styles.clients__logos, "col-lg-6")}>
            <div className="d-flex justify-content-between align-items-center mb-5">
              <div className={styles.clients__logos__item_1}>
                <div data-aos="fade-in">
                  <StaticImage alt="" quality={80} src="./logo-sendcloud.png" />
                </div>
              </div>
              <div className={styles.clients__logos__item_2}>
                <div data-aos="fade-in">
                  <StaticImage alt="" quality={80} src="./logo-klooker.png" />
                </div>
              </div>
              <div className={styles.clients__logos__item_3}>
                <div data-aos="fade-in">
                  <StaticImage alt="" quality={80} src="./logo-cla.png" />
                </div>
              </div>
            </div>
            <div className="d-flex justify-content-between align-items-center">
              <div className={styles.clients__logos__item_4}>
                <div data-aos="fade-in">
                  <StaticImage alt="" quality={80} src="./logo-alpian.png" />
                </div>
              </div>
              <div className={styles.clients__logos__item_5}>
                <div data-aos="fade-in">
                  <StaticImage alt="" quality={80} src="./logo-tiktok.png" />
                </div>
              </div>
              <div className={styles.clients__logos__item_6}>
                <div data-aos="fade-in">
                  <StaticImage alt="" quality={80} src="./logo-h.png" />
                </div>
              </div>
              <div className={styles.clients__logos__item_7}>
                <div data-aos="fade-in">
                  <StaticImage alt="" quality={80} src="./logo-elugie.png" />
                </div>
              </div>
            </div>
          </div>
