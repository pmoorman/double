...
export const PricingSection = () => {
  return (
    <section id="pricing" className="pricing py-0">
      ...
      {/* Content */}
      <div className="pricing__content container position-relative">
        {/* Background */}
        <div className="pricing__content__bg"></div>
          ...
          <div className="col-lg-7 position-relative">
            ...
            <div className="pricing__content__col2">
              <div className="d-flex flex-column text-right">
                <h2 className="pricing__content__col2__price">€90</h2>
        ...
        {/* bottom */}
        <div className="pricing__bottom row mt-4 mt-lg-0">
